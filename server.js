...
const DISEASE_COUNTRIES = [
  ...
  { id: 'india',       name: 'อินเดีย',          nameEn: 'India',       flag: '🇮🇳', row: 'sea',
    keywords: ['india', 'indian', 'อินเดีย', 'andhra', 'odisha', 'gujarat', 'vannamei india', 'mpeda'] },
  { id: 'bangladesh',  name: 'บังกลาเทศ',        nameEn: 'Bangladesh',  flag: '🇧🇩', row: 'sea',
    keywords: ['bangladesh', 'bangladeshi', 'บังกลาเทศ', 'চিংড়ি', 'khulna', 'satkhira'] },
  { id: 'myanmar',     name: 'เมียนมา',          nameEn: 'Myanmar',     flag: '🇲🇲', row: 'sea',
    keywords: ['myanmar', 'burma', 'burmese', 'เมียนมา', 'yangon', 'ပုဇွန်'] },
  { id: 'thailand',    name: 'ไทย',              nameEn: 'Thailand',    flag: '🇹🇭', row: 'sea',
    keywords: ['thailand', 'thai', 'ไทย', 'กุ้ง', 'สุราษฎร์', 'สงขลา', 'ชุมพร', 'ระยอง'] },
  { id: 'vietnam',     name: 'เวียดนาม',         nameEn: 'Vietnam',     flag: '🇻🇳', row: 'sea',
    keywords: ['vietnam', 'viet', 'vietnamese', 'เวียดนาม', 'tôm', 'vasep', 'cà mau', 'bạc liêu', 'sóc trăng'] },
  { id: 'malaysia',    name: 'มาเลเซีย',         nameEn: 'Malaysia',    flag: '🇲🇾', row: 'sea',
    keywords: ['malaysia', 'malaysian', 'มาเลเซีย', 'udang malaysia', 'sarawak', 'sabah', 'aquakultur'] },
  { id: 'philippines', name: 'ฟิลิปปินส์',       nameEn: 'Philippines', flag: '🇵🇭', row: 'sea',
    keywords: ['philippines', 'philippine', 'filipino', 'ฟิลิปปินส์', 'hipon', 'bfar', 'palawan', 'mindanao'] },
  { id: 'indonesia',   name: 'อินโดนีเซีย',      nameEn: 'Indonesia',   flag: '🇮🇩', row: 'sea',
    keywords: ['indonesia', 'indonesian', 'อินโดนีเซีย', 'udang', 'kkp', 'jawa', 'sulawesi', 'kalimantan'] },
  // East Asia / Pacific
